...
import 'package:bt_wallet/modules/ble_payment/common/bluetooth_off.dart';
import 'package:bt_wallet/modules/ble_payment/payer/hex_painter.dart';
import 'package:bt_wallet/modules/ble_payment/payer/payee.dart';
import 'package:bt_wallet/modules/ble_payment/payer/payment.dart';
...
class _PayeeListScreenState extends State<PayeeListScreen> {
  ...
  Future<void> _waitForBluetoothPoweredOn() async {
    ...
    StreamSubscription<BluetoothState> subscription = _bleManager.observeBluetoothState()
