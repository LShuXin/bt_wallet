...
import 'package:bt_wallet/modules/ble_payment/common/tx_store.dart';
import 'package:bt_wallet/modules/ble_payment/payee/session.dart';
...
class PaymentScreen extends StatefulWidget {
  ...
  const PaymentScreen(this.name, this.address, this.amount, {super.key});
