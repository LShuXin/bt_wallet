...
mixin _$IdentityStore on IdentityStoreBase, Store {
  ...
  bool _selectedIdentityIsInitialized = false;

  @override
  set selectedIdentity(Optional<DecentralizedIdentity> value) {
    _$selectedIdentityAtom.reportWrite(
        value, _selectedIdentityIsInitialized ? super.selectedIdentity : null,
        () {
      super.selectedIdentity = value;
      _selectedIdentityIsInitialized = true;
    });
  }
