...
import 'package:bt_wallet_flutter_01/store/issuer_store.dart';
import 'package:bt_wallet_flutter_01/widgets/card_group.dart';
...
import 'package:bt_wallet_flutter_01/widgets/scan_icon.dart';
import 'package:bt_wallet_flutter_01/widgets/vc_type_card.dart';

class VerificationScenarioPage extends StatefulWidget {
  const VerificationScenarioPage({super.key});

  @override
  createState() => _VerificationScenarioPage();
}
