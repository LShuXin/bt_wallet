...
import 'package:bt_wallet/models/eth_tx_info/eth_tx_info.dart';
import 'package:bt_wallet/service/blockchain_service.dart';
import 'package:bt_wallet/service/rlp.dart';
...
void main() {
  ...
  group('ecdsa test', () {
    ...
    final publicKey = decompressPublicKey(hexToBytes(keyPair.item1)).sublist(1);

    final Uint8List messageHash =
        keccak256(Uint8List.fromList(utf8.encode('hello world')));

    final MsgSignature msgSignature =
        sign(messageHash, hexToBytes(keyPair.item2));
